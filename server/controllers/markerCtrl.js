module.exports = {
    newtrip: async (req, res) => {
        ...
        req.session.user[1].splice(0, 0, { country, city, lat, lng, trip_id: addedtrip.trip_id, icon: 'http://maps.google.com/mapfiles/ms/icons/red-dot.png', start_date: null, end_date: null, rating: null, comment: null, file: null })
